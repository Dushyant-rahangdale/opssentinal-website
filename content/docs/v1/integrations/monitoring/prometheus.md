...
Send Prometheus alerts to OpsSentinel via Alertmanager.
...
Add OpsSentinel as a receiver in `alertmanager.yml`:
...
1. Trigger a test alert:
   ...
   ```
2. Verify incident in OpsSentinel
3. Resolve the alert
